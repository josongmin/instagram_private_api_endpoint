...
public class WebLoadFollowerCall extends InstaWebApiCall {

    public WebLoadFollowerCall(InstaWebApiClient client) {
        super(client);
    }
    ...
    public ApiResult<InstaUsers> work() throws Exception{
        ...
        String url = "https://www.instagram.com/graphql/query/?query_id=" + "17851374694183129" + "&variables=" + jsonParam;
        ...
        jsonObject = jsonObject.getJSONObject("user").getJSONObject("edge_followed_by");
