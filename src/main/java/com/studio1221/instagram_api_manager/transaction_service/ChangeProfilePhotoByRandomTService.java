...
import com.studio1221.instagram_api_manager.endpoint.instagram_web.WebChangeProfilePictureCall;
...
public class ChangeProfilePhotoByRandomTService extends ApiCall {

    InstaWebApiClient instaWebApiClient = null;

    public ChangeProfilePhotoByRandomTService(InstaWebApiClient instaWebApiClient) {
    ...
    public ApiResult<String> work() throws Exception {
        ...
        //업로드
        ApiResult changeResult = new WebChangeProfilePictureCall(instaWebApiClient).setParam("filePath", fileResult.object).syncWork();
